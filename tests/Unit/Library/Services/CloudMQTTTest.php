...
class CloudMQTTTest extends TestCase
{
    public function providerMakeFeedName()
    {
        return [
            ...
            [\App\Library\Services\CloudMQTT::FEED_WATERSENSOR, 'f/a/keui/d', 'dribly/watersensors/update/fakeuid/'],
            ...
            [\App\Library\Services\CloudMQTT::FEED_TAPREPLY, 'fakeuid', 'dribly/taps/response/fakeuid/'],
